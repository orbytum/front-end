...
export function GrupoCombobox() {
  ...
  return (
    <div className="relative inline-block text-left" ref={containerRef}>
      ...
      {aberto && (
        <div className="absolute left-0 mt-2 w-72 origin-top-left rounded-xl bg-card border border-border/60 p-1.5 shadow-2xl shadow-black/80 z-50 animate-in fade-in-50 zoom-in-95 duration-150">

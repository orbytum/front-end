...
const CORES_DOS_TIPOS: Record<TipoPublicacao, string> = {
  ...
  "Outro": "bg-[#8b96a5]/20 text-[#8b96a5]",
};
  ...
  return (
    <div className="h-full overflow-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-[#8b96a5]">Repositório de produções científicas do grupo de pesquisa</p>
      </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mb-2 flex-wrap">
                  ...
                  {publicacao.temDocumento && (
                    <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#3d4f62]/30 text-[#8b96a5]">
                ...
                <p className="text-[#8b96a5] text-sm mb-3 line-clamp-2">{publicacao.descricao}</p>
      ...
      {filtradas.length === 0 && (
        <div className="text-center py-12 bg-[#0d1f30] rounded-2xl border border-[#3d4f62]/30">
          <BookOpen className="w-16 h-16 text-[#3d4f62] mx-auto mb-4" />
          <p className="text-[#8b96a5]">Nenhuma publicação encontrada</p>
        </div>
      )}
          ...
          <div className="w-full max-w-lg bg-[#0d1f30] rounded-2xl border border-[#3d4f62]/30 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-[#8b96a5] mb-1.5 font-normal">Data da Publicação *</label>
                  <input
                    type="date"
              ...
              <div>
                <label className="block text-sm text-[#8b96a5] mb-1.5 font-normal">Link (DOI, repositório...)</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm text-[#8b96a5] mb-1.5 font-normal">Documento PDF</label>
                <div className="w-full px-4 py-3 bg-[#0a1929] rounded-xl border border-dashed border-[#3d4f62]/50 text-[#8b96a5] text-sm flex items-center gap-2 cursor-pointer hover:border-[#ff8c42]/40 transition-colors">
